...
from mtgs.scene_model.gaussian_model.vanilla_gaussian_splatting import VanillaGaussianSplattingModelConfig
from mtgs.scene_model.gaussian_model.rigid_node_mirrored import MirroredRigidSubModelConfig
    ...
    pipeline=MultiTravelEvalPipielineConfig(
        datamanager=CustomFullImageDatamanagerConfig(
            dataparser=NuplanDataParserConfig(
                load_3D_points=True,
                only_moving=True,          # if multi-traversal, disable this.
                undistort_images="optimal",
            ),
            camera_res_scale_factor=1.0,
            dynamic_scaling_factor_stages=2,
        ...
        model=MTGSSceneModelConfig(
            control=GaussianSplattingControlConfig(
                ...
                cull_screen_size=150 * 2,
                split_screen_size=100 * 2,
                sh_degree=3,
            ...
            model_config=dict(
                ...
                rigid_object=MirroredRigidSubModelConfig(
                    model_type='rigid',
